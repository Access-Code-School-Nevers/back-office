   ...
   <body>
     <header>
       <section id="nav-backOffice">
         ...
         <nav id="nav-user">
           <ul id="liste-users">
             <li> <a class="nav-link-user" href="index.php"> <i class="far fa-user"></i></a></li>
             <li><a href="deconexion.php" class="nav-link-user">Déconexion</a></li>
           </ul>
         </nav>
       </section>
     ...
     <section>
       <div id="mySidenav" class="sidenav">
           ...
           <a class="link-sidebar" href="#">Créer un article</a>
